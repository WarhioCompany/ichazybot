...
GET_EMAIL_MESSAGE = 'Напиши свой email, указанный при регистрации в приложении'
SECOND_TRY_MESSAGE = 'Я долго искал, такой почты нет нигде, попробуй еще раз'
CAN_NOT_FIND = 'И сейчас ничего, это что, пранк? Напиши свой ник в приложении iChazy, наши архивные крыски хорошенько поищут'
